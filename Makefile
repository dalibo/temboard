...
install-%: venv-%
	...
	dev/venv-py$*/bin/pip install --upgrade --target agent/temboardagent/_vendor -r agent/vendor.txt
	dev/venv-py$*/bin/pip install --upgrade --target ui/temboardui/_vendor -r ui/vendor.txt

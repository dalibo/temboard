...
class AsyncResult(object):
    def __init__(self, http_code = 0, content_type = "application/unknown", data = {}):
        self.http_code = http_code
        self.content_type = content_type
        self.data = data

class HTMLAsyncResult(AsyncResult):
    def __init__(self, http_code = 0, redirection = None, data = {}, template_file = None, template_path = None, secure_cookie = None):

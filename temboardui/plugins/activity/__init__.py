...
class ActivityWBHandler(BaseHandler):
    def get_activity_w_b(self, agent_address, agent_port, mode):
        try:
            ...
            # Load activity.
            if mode == 'waiting':
                activity_data = temboard_activity_waiting(self.ssl_ca_cert_file, instance.agent_address, instance.agent_port, xsession)
            elif mode == 'blocking':
...
class ActivityWBProxyHandler(JsonHandler):
    def get_activity_w_b(self, agent_address, agent_port, mode):
        try:
            ...
            # Load activity.
            if mode == 'waiting':
                data_activity = temboard_activity_waiting(self.ssl_ca_cert_file, instance.agent_address, instance.agent_port, xsession)
            elif mode == 'blocking':

...
function load_update_instance_form(modal_id, agent_address, agent_port)
{
  $.ajax({
    ...
    success: function (data) {
      ...
      body_html += '      <input type="text" class="form-control input-sm" id="inputNewAgentAddress" placeholder="Agent Address" value="'+data['agent_address']+'" />';
      body_html += '    </div>';
      body_html += '    <div class="form-group col-sm-6">';
      body_html += '      <label for="inputNewAgentPort" class="control-label">Agent port</label>';
      body_html += '      <input type="text" class="form-control input-sm" id="inputNewAgentPort" placeholder="Agent Port" value="'+data['agent_port']+'" />';
      body_html += '    </div>';
      body_html += '  </div>';
      body_html += '  <div class="row">';
...
function load_add_instance_form(modal_id)
{
  $.ajax({
    ...
    success: function (data) {
      ...
      body_html += '    <div class="form-group col-sm-6">';
      body_html += '      <label for="inputNewAgentAddress" class="control-label">Agent address</label>';
      body_html += '      <input type="text" class="form-control input-sm" id="inputNewAgentAddress" placeholder="Agent Address" />';
      body_html += '    </div>';
      body_html += '    <div class="form-group col-sm-6">';
      body_html += '      <label for="inputNewAgentPort" class="control-label">Agent port</label>';
      body_html += '      <input type="text" class="form-control input-sm" id="inputNewAgentPort" placeholder="Agent Port" />';
      body_html += '    </div>';
      body_html += '  </div>';
      body_html += '  <div class="row">';
      body_html += '    <div class="form-group col-sm-12">';

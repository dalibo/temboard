...
def temboard_post_configuration(in_ca_cert_file, hostname, port, xsession, settings):
    try:
        res = temboard_request(
                in_ca_cert_file,
                method = 'POST',
...
def temboard_get_configuration_categories(in_ca_cert_file, hostname, port, xsession):
    try:
        res = temboard_request(
                in_ca_cert_file,
                method = 'GET',
...
def temboard_get_configuration_status(in_ca_cert_file, hostname, port, xsession):
    try:
        res = temboard_request(
                in_ca_cert_file,
                method = 'GET',
...
def temboard_post_administration_control(in_ca_cert_file, hostname, port, xsession, action):
    try:
        res = temboard_request(
                in_ca_cert_file,
                method = 'POST',
...
def temboard_delete_hba_version(in_ca_cert_file, hostname, port, xsession, version):
    try:
        res = temboard_request(
                in_ca_cert_file,
                method = 'DELETE',

  ...
  <ModalDialog id="modalMigrationGroups" :title="title">
    <div class="modal-body text-justify">
      ...
      <template v-if="objectClass === 'instance'">
        ...
        <p>
          temBoard 9.0 is planned to remove the ability to put an instance in several groups of instances. To prepare
          the upgrade, review your configuration to put this instance in a single group of instances.
        </p>
